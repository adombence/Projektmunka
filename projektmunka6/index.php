    ...
    <div class="row">
        ...
        <div class="side">
            ...
            <form action="php/postKonyv.php" method="post" class="form">
                ...
                <input type="submit" id="kesz" value="Kész">
            </form>
        </div>
        <div class="main">
            <!--SZERZŐ MEGADÁSA-->
            ...
            <form action="php/postSzerzo.php" method="post" class="form">
                <div id="select">
                    <select name="szerzok" id="szerzok" class="select" name="select">
                    ...
                    <button onclick="szerzoid()" id="hidden_button" class="kesz" style="display: none;">kész</button>
                </div>
                ...
                <div id="hidden_div2" style="display: none;">
                    ...
                    <div class="kisrow">
                        <div class="kisside">
                            ...
                            <label for="nem1">Férfi</label></div>
                        <div class="kismain">
                            <input type="radio" id="nem0" name="nem" value="0">
                            <label for="nem0">Nő</label><br></div>
                    </div>
