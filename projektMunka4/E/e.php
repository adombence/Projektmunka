...
WHERE (((szemely.az)=szemaz) AND ((kapcsolo.fogaz) In (SELECT fogaz FROM szemely, kapcsolo WHERE az=szemaz AND nev='Pitti Katalin')))";
...
<body>
    ...
    <div class="navbar">
        ...
        <a href="../E/e.php" class="active">6pitti</a>
    ...
    <div class="row">
        <div class="side">
            <h2>6pitti</h2>
            <p>Sorolja fel Pitti Katalinnal együtt azoknak a nevét és a kitüntetés évét, akik vele azonos
                foglalkozásúak!</p>
        </div>
        <div class="main">
            <table>
